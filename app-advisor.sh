...
Auto-generated commit by GitHub Actions"
  ...
  gh pr create --title "Spring Upgrade using SAA" --body "Automated Spring upgrade generated by Spring Application Advisor v$VERSION" --head "$BRANCH_NAME" --base main
